...
test_that("generate_synthetic_data returns correct structure", {
  ...
  expected_cols <- c("record_id", "centre_code", "centre_name", "consultant",
                     "age", "gender", "dxs01", "qblg9", "hdp01", "hdp02",
                     "qblg3", "qblg4", "qblg6", "qblg7", "qblb1", "qblb4",
                     "qblb9", "qbla9", "qbla4", "qble1", "qblf1", "qhd20")
...
test_that("generate_synthetic_data has 7 centres", {
  df <- generate_synthetic_data(seed = 1, n_total = 100)
  expect_equal(length(unique(df$centre_code)), 7)
})
